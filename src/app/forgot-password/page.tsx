...
export default async function ForgotPasswordPage(props: { searchParams: Promise<{ message: string }> }) {
  ...
  return (
    <div className="min-h-[100dvh] flex items-center justify-center bg-slate-50 selection:bg-blue-100 text-slate-900 font-sans relative overflow-hidden px-4 py-8 sm:py-12">
      ...
      <div className="fixed top-0 left-1/3 w-[800px] h-[800px] bg-blue-100/30 rounded-full blur-[120px] -z-10" />
      <div className="fixed bottom-0 right-1/3 w-[600px] h-[600px] bg-indigo-100/20 rounded-full blur-[120px] -z-10" />
