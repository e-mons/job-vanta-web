    ...
    <div className="min-h-[100dvh] flex items-center justify-center bg-slate-50 selection:bg-blue-100 text-slate-900 font-sans relative overflow-hidden px-4 py-8 sm:py-12">
      ...
      <div className="relative z-10 w-full max-w-[480px]">
        ...
        <div className="flex flex-col items-center mb-8 sm:mb-10">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-50 border border-emerald-100 text-[10px] font-bold text-emerald-600 uppercase tracking-widest mb-6">
            <ShieldCheck className="w-3.5 h-3.5" />
            Secure Password Reset
          </div>
          
          <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 mb-3 text-center">Set new password</h1>
        ...
        <div className="bg-white border border-slate-200 shadow-2xl shadow-blue-900/5 rounded-[2rem] sm:rounded-[40px] p-6 sm:p-10 relative overflow-hidden">
          {/* Subtle accent line */}
          <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-emerald-500 to-blue-600" />
